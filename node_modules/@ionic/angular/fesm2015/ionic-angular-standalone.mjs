...
export { AlertController, Config, DomController, IonicRouteStrategy, LoadingController, NavController, NavParams, PickerController, Platform } from '@ionic/angular/common';
...
import { modalController, popoverController, initialize, actionSheetController, createAnimation, getTimeGivenProgression, createGesture, menuController, toastController } from '@ionic/core/components';
