...
export { AlertController, AngularDelegate, Config, DomController, IonicRouteStrategy, LoadingController, NavController, NavParams, PickerController, Platform } from '@ionic/angular/common';
import { __decorate } from 'tslib';
import { fromEvent } from 'rxjs';
import * as i1 from '@angular/common';
import { DOCUMENT, CommonModule } from '@angular/common';
import * as i2 from '@angular/router';
import { createAnimation, getTimeGivenProgression, actionSheetController, createGesture, menuController, modalController, popoverController, toastController, setupConfig } from '@ionic/core';
