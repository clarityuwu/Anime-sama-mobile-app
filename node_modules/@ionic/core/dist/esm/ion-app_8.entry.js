 ...
 */
import { r as registerInstance, h, H as Host, f as getElement, d as createEvent, e as readTask, i as forceUpdate, w as writeTask } from './index-7c9b1bca.js';
import { b as getIonMode, c as config, a as isPlatform } from './ionic-global-40e42e7f.js';
...
import { t as transition } from './index-6a0ccabb.js';
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (config.getBoolean('statusTap', isHybrid)) {
          import('./status-tap-9ce68758.js').then((module) => module.startStatusTap());
        }
