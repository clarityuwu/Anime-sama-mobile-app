...
const createElm = (e, t, o, n) => {
 ...
 return BUILD.slotRelocation && (a["s-hn"] = hostTagName, 3 & l.$flags$ && (a["s-sr"] = !0, 
 ...
 if (hostTagName = l.tagName, BUILD.isDev && Array.isArray(t) && t.some(isHost)) throw new Error(`The <Host> must be the single root component.\nLooks like the render() function of "${hostTagName.toLowerCase()}" is returning an array that contains the <Host>.\n\nThe render() function should look like this instead:\n\nrender() {\n  // Do not return an array\n  return (\n    <Host>{content}</Host>\n  );\n}\n  `);
 if (BUILD.reflect && a.$attrsToReflect$ && (i.$attrs$ = i.$attrs$ || {}, a.$attrsToReflect$.map((([e, t]) => i.$attrs$[t] = l[e]))), 
 o && i.$attrs$) for (const e of Object.keys(i.$attrs$)) l.hasAttribute(e) && ![ "key", "ref", "style", "class" ].includes(e) && (i.$attrs$[e] = l[e]);
 if (i.$tag$ = null, i.$flags$ |= 4, e.$vnode$ = i, i.$elm$ = r.$elm$ = BUILD.shadowDom && l.shadowRoot || l, 
 (BUILD.scoped || BUILD.shadowDom) && (scopeId = l["s-sc"]), BUILD.slotRelocation && (contentRef = l["s-cr"], 
  ...
  if (plt.$flags$ |= 1, checkSlotRelocate) {
   ...
   for (const e of relocateNodes) {
    ...
    if (o) {
     ...
     let l = o.nextSibling;
     if (!BUILD.experimentalSlotFixes || l && 1 === l.nodeType) {
     ...
     BUILD.experimentalSlotFixes && 1 === t.nodeType && o["s-fs"] !== t.getAttribute("slot") && (o["s-fs"] ? t.setAttribute("slot", o["s-fs"]) : t.removeAttribute("slot")), 
     e.insertBefore(t, l));
...
const callRender = (e, t, o, n) => {
 ...
 BUILD.shadowDom && !supportsShadow && 1 & o.$flags$ && (o.$flags$ |= 8), BUILD.experimentalSlotFixes && BUILD.scoped ? patchPseudoShadowDom(e.prototype, o) : (BUILD.slotChildNodesFix && patchChildSlotNodes(e.prototype, o), 
 ...
 if (e.map((e => {
  e[1].map((o => {
   ...
   4 & r.$flags$ && (u = !0), BUILD.member && (r.$members$ = o[2]), BUILD.hostListener && (r.$listeners$ = o[3]), 
   ...
   BUILD.experimentalSlotFixes && BUILD.scoped ? patchPseudoShadowDom(d.prototype, r) : (BUILD.slotChildNodesFix && patchChildSlotNodes(d.prototype, r), 
 ...
 })), u && (d.innerHTML += SLOT_FB_CSS), BUILD.invisiblePrehydration && (BUILD.hydratedClass || BUILD.hydratedAttribute) && (d.innerHTML += s + "{visibility:hidden}.hydrated{visibility:inherit}"), 
 d.innerHTML.length) {
  d.setAttribute("data-styles", ""), r.insertBefore(d, i ? i.nextSibling : r.firstChild);
