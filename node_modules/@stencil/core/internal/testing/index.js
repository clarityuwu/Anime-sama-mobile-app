...
const createTime = (e, t = "") => {
 ...
 return () => {};
}, SLOT_FB_CSS = "slot-fb{display:contents}slot-fb[hidden]{display:none}", XLINK_NS = "http://www.w3.org/1999/xlink", EMPTY_OBJ = {}, isComplexType = e => "object" == (e = typeof e) || "function" === e, h = (e, t, ...a) => {
...
const createElm = (e, t, a, o) => {
 ...
 return appData.BUILD.slotRelocation && (l["s-hn"] = hostTagName, 3 & n.$flags$ && (l["s-sr"] = !0, 
 l["s-fs"] = null === (s = n.$attrs$) || void 0 === s ? void 0 : s.slot, l["s-cr"] = contentRef, 
 l["s-sn"] = n.$name$ || "", i = e && e.$children$ && e.$children$[a], i && i.$tag$ === n.$tag$ && e.$elm$ && putBackInOriginalLocation(e.$elm$, !1))), 
 l;
 ...
 var o, s;
 const n = e.$hostElement$, l = e.$cmpMeta$, r = e.$vnode$ || newVNode(null, null), i = isHost(t) ? t : h(null, null, t);
 if (hostTagName = n.tagName, appData.BUILD.isDev && Array.isArray(t) && t.some(isHost)) throw new Error(`The <Host> must be the single root component.\nLooks like the render() function of "${hostTagName.toLowerCase()}" is returning an array that contains the <Host>.\n\nThe render() function should look like this instead:\n\nrender() {\n  // Do not return an array\n  return (\n    <Host>{content}</Host>\n  );\n}\n  `);
 if (appData.BUILD.reflect && l.$attrsToReflect$ && (i.$attrs$ = i.$attrs$ || {}, 
 l.$attrsToReflect$.map((([e, t]) => i.$attrs$[t] = n[e]))), a && i.$attrs$) for (const e of Object.keys(i.$attrs$)) n.hasAttribute(e) && ![ "key", "ref", "style", "class" ].includes(e) && (i.$attrs$[e] = n[e]);
 if (i.$tag$ = null, i.$flags$ |= 4, e.$vnode$ = i, i.$elm$ = r.$elm$ = appData.BUILD.shadowDom && n.shadowRoot || n, 
 (appData.BUILD.scoped || appData.BUILD.shadowDom) && (scopeId = n["s-sc"]), appData.BUILD.slotRelocation && (contentRef = n["s-cr"], 
 useNativeShadowDom = exports.supportsShadow && 0 != (1 & l.$flags$), checkSlotFallbackVisibility = !1), 
 patch(r, i), appData.BUILD.slotRelocation) {
  if (plt.$flags$ |= 1, checkSlotRelocate) {
   ...
   for (const e of relocateNodes) {
    const t = e.$nodeToRelocate$, a = e.$slotRefNode$;
    if (a) {
     const e = a.parentNode;
     let n = a.nextSibling;
     if (!appData.BUILD.experimentalSlotFixes || n && 1 === n.nodeType) {
      let a = null === (o = t["s-ol"]) || void 0 === o ? void 0 : o.previousSibling;
      for (;a; ) {
       let o = null !== (s = a["s-nr"]) && void 0 !== s ? s : null;
     ...
     (!n && e !== t.parentNode || t.nextSibling !== n) && t !== n && (!t["s-hn"] && t["s-ol"] && (t["s-hn"] = t["s-ol"].parentNode.nodeName), 
     appData.BUILD.experimentalSlotFixes && 1 === t.nodeType && a["s-fs"] !== t.getAttribute("slot") && (a["s-fs"] ? t.setAttribute("slot", a["s-fs"]) : t.removeAttribute("slot")), 
     e.insertBefore(t, n));
...
const callRender = (e, t, a, o) => {
 ...
 appData.BUILD.experimentalSlotFixes && appData.BUILD.scoped ? patchPseudoShadowDom(e.prototype, a) : (appData.BUILD.slotChildNodesFix && patchChildSlotNodes(e.prototype, a), 
...
exports.addHostEventListeners = addHostEventListeners, exports.bootstrapLazy = (e, t = {}) => {
 ...
 if (e.map((e => {
  e[1].map((a => {
   ...
   appData.BUILD.experimentalSlotFixes && appData.BUILD.scoped ? patchPseudoShadowDom(p.prototype, r) : (appData.BUILD.slotChildNodesFix && patchChildSlotNodes(p.prototype, r), 
   appData.BUILD.cloneNodeFix && patchCloneNode(p.prototype), appData.BUILD.appendChildSlotFix && patchSlotAppendChild(p.prototype), 
   appData.BUILD.scopedSlotTextContentFix && patchTextContent(p.prototype, r)), appData.BUILD.formAssociated && 64 & r.$flags$ && (p.formAssociated = !0), 
 ...
 p.innerHTML.length) {
  p.setAttribute("data-styles", ""), r.insertBefore(p, i ? i.nextSibling : r.firstChild);
