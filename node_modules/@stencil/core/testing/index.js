/*!
 Stencil Testing v4.7.2 | MIT Licensed | https://stenciljs.com
 */
...
class Cache {
 ...
 async clearExpiredCache() {
  ...
  if (null != t) {
   ...
   const r = this.cacheFs.sys, s = await r.readDir(this.buildCacheDir), n = s.map((e => join(this.buildCacheDir, e)));
   let o = 0;
...
defaultIsFile$1 = function e(t, r) {
 ...
 function n(e) {
  ...
  "." !== t && ".." !== t && "/" !== t.slice(-1) || (T += "/"), /\/$/.test(t) && T === e ? l(T, $.package, o) : i(T, $.package, o); else {
   if (y && isCoreModule(t)) return S(null, t);
   !function r(e, t, s) {
    var n = function() {
 ...
 function i(e, t, r) {
  ...
  "function" == typeof s && (n = s, s = void 0), function e(t, r, s) {
   function o(s, o, a) {
    ...
    h = $.pathFilter(c, r, p)) ? e([ "" ].concat(v.slice()), path__default.default.resolve(a, h), c) : void d(l, i);
   }
   function i(s, o) {
 ...
 var u, d, p, h, f, m, g, w, v, y, _, E, b, T, S = s, $ = r;
 ...
 process.nextTick((function() {
  S(g);
 }))) : (w = $.packageIterator, v = $.extensions || [ ".js" ], y = !1 !== $.includeCoreModules, 
...
defaultIsFile = function e(t) {
 ...
 var i, a, l, c, u, d, p, h, f, m, g, w, v, y, _, E;
 ...
 w = maybeRealpathSync(u, path__default.default.resolve(m), i), /^(?:\.\.?(?:\/|$)|\/|([A-Za-z]:)?[/\\])/.test(t)) {
  if (v = path__default.default.resolve(w, t), "." !== t && ".." !== t && "/" !== t.slice(-1) || (v += "/"), 
  y = s(v) || o(v)) return maybeRealpathSync(u, y, i);
 } else {
